...
public class NasaApiControllerUnitTests {
    ...
    public void givenListOfNasaApods_whenGetAllApods_thenReturnListOfApods() throws Exception
    {
        ...
        nasaApods.add(NasaApod.builder().copyright("Aniket").explanation("Some Random Sentence By Aniket Shelke").hdurl("https://www.nasa.gov/image-detail/simsbury-oli2-2022258-lrg/").title("Narendra Modi :)").url("https://www.nasa.gov/image-detail/simsbury-oli2-2022258-lrg/").build());
        // stubbing methods //
