...
public class NasaApiServiceUnitTests {
	...
	public void setup() {
		...
		theNasaApod = NasaApod.builder().copyright("Aniket Shelke").date("04-01-2002")
				.explanation("This Is Just A Random Sentence")
				.hdurl("https://www.nasa.gov/image-detail/simsbury-oli2-2022258-lrg/").title("Demo Title")
				.url("https://www.nasa.gov/image-detail/simsbury-oli2-2022258-lrg/").build();
	}
	...
	public void givenNasaApodObjects_whenFetchAllApods_thenReturnListOfApods() {
		...
		NasaApod theNasaApod2 = theNasaApod = NasaApod.builder().copyright("Aniket Shelke").date("04-01-2002")
	...
	public void givenNasaObject_whenFindNasaApodById_thenReturnFoundNasaApod() {
		...
		assertThat(foundNasaApod.getCopyright()).isEqualTo("Aniket Shelke");
	}
